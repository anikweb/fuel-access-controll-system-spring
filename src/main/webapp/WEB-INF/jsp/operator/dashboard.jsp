...
<my:layout title="অপারেটর ড্যাশবোর্ড | FACS">
<section id="operator-dashboard" class="w-full max-w-5xl mx-auto flex flex-col gap-6">
    ...
    <article class="bg-white border border-gray-200 rounded-xl shadow-[0_1px_2px_rgba(16,24,40,0.04),0_8px_24px_rgba(16,24,40,0.06)] p-6 sm:p-7 flex items-center gap-5">
        ...
        <div class="flex-1 min-w-0">
            <h1 class="text-[20px] font-bold text-gray-900 tracking-tight">অপারেটর প্যানেল</h1>
    ...
    <article class="bg-white border border-gray-200 rounded-xl p-6 sm:p-7">
        <p class="text-sm text-gray-600">এখানে অপারেটর ফিচারগুলো শীঘ্রই যুক্ত হবে।</p>
    </article>
